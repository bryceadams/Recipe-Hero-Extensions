...
class RH_Video_Updater {
	...
	public function admin_init() {
		...
		if ( ! empty( $_POST[ $this->plugin_slug . '_licence_key' ] ) ) {
			...
			try {
				...
				$activate_results = json_decode( RH_Video_Updater_Key_API::activate( array(
					'email'          => $email,
	...
	public function deactivate_licence() {
		...
		$reset = RH_Video_Updater_Key_API::deactivate( array(
				'api_product_id' => $this->plugin_slug,
...
new RH_Video_Updater( plugin_dir_path( __FILE__ ) . '../recipe-hero-video.php' );