...
class RH_Likes_Updater {
	...
	public function admin_init() {
		...
		if ( ! empty( $_POST[ $this->plugin_slug . '_licence_key' ] ) ) {
			...
			try {
				...
				$activate_results = json_decode( RH_Likes_Updater_Key_API::activate( array(
					'email'          => $email,
	...
	public function deactivate_licence() {
		...
		$reset = RH_Likes_Updater_Key_API::deactivate( array(
				'api_product_id' => $this->plugin_slug,
...
new RH_Likes_Updater( plugin_dir_path( __FILE__ ) . '../recipe-hero-likes.php' );